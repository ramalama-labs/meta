# RamaLama Container for Qwen3 VL 2B Instruct
...
```bash
docker pull rlcr.io/ramalama/qwen3-vl-2b-instruct:latest
docker run -p 8080:8080 rlcr.io/ramalama/qwen3-vl-2b-instruct:latest
```
