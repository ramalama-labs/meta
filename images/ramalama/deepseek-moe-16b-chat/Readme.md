# RamaLama Container for DeepSeek MoE 16B Chat
...
```bash
docker pull rlcr.io/ramalama/deepseek-moe-16b-chat:latest
docker run -p 8080:8080 rlcr.io/ramalama/deepseek-moe-16b-chat:latest
```
