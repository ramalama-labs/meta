# RamaLama Container for DeepSeek R1 Qwen3 8B
...
```bash
docker pull rlcr.io/ramalama/deepseek-r1-qwen3-8b:latest
docker run -p 8080:8080 rlcr.io/ramalama/deepseek-r1-qwen3-8b:latest
```
