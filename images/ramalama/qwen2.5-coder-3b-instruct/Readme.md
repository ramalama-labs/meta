# RamaLama Container for Qwen 2.5
...
```bash
docker pull rlcr.io/ramalama/qwen2.5-coder-3b-instruct:latest
docker run -p 8080:8080 rlcr.io/ramalama/qwen2.5-coder-3b-instruct:latest
```
