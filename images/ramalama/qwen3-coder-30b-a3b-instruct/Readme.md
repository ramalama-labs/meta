# RamaLama Container for Qwen3 Coder 30B A3B Instruct
...
```bash
docker pull rlcr.io/ramalama/qwen3-coder-30b-a3b-instruct:latest
docker run -p 8080:8080 rlcr.io/ramalama/qwen3-coder-30b-a3b-instruct:latest
```
