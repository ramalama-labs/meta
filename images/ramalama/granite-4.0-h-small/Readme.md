# RamaLama Container for Granite 4.0 H Small
...
```bash
docker pull rlcr.io/ramalama/granite-4.0-h-small:latest
docker run -p 8080:8080 rlcr.io/ramalama/granite-4.0-h-small:latest
```
