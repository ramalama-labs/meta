# RamaLama Container for Qwen2.5 Omni 3B
...
```bash
docker pull rlcr.io/ramalama/qwen2.5-omni-3b:latest
docker run -p 8080:8080 rlcr.io/ramalama/qwen2.5-omni-3b:latest
```
